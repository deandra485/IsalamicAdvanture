    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="px-4 py-6 space-y-3 bg-white">
                ...
                <a href="{{ route('reviews.index') }}" class="flex items-center justify-between px-4 py-3 rounded-xl text-base font-medium transition-colors {{ request()->routeIs('reviews.*') ? 'bg-primary-50 text-primary-700' : 'text-gray-600 hover:bg-gray-50' }}">
